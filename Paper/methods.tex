...
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.6\linewidth]{thresholdd6zoom.png}
  \label{fig:nothresholdd6}
  \subcaption{The image before being thresholded.}
\end{subfigure}%
\begin{subfigure}{.5\textwidth}
  \centering
  \includegraphics[width=.6\linewidth]{nothresholdd6zoom.png}
...
\begin{figure}[htpb]
	\centering
	\includegraphics[width=0.45\linewidth]{flowlast.png}
